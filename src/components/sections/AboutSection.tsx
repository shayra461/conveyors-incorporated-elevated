...
export function AboutSection() {
  ...
  return (
    <section className="py-12 md:py-20 lg:py-24 bg-slate-950 text-white relative overflow-hidden" ref={ref}>
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <span className="text-accent font-bold tracking-widest uppercase text-xs sm:text-sm mb-3 md:mb-4 block">Who We Are</span>
          <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold mb-4 md:mb-6">
        ...
        >
          ...
          <motion.div
            ...
            className="md:col-span-4 lg:col-span-2 md:row-span-2 bg-slate-900 rounded-2xl md:rounded-3xl p-6 md:p-10 lg:p-12 flex flex-col justify-between border border-white/5 relative overflow-hidden group"
          >
          ...
          <motion.div
            variants={itemVariants}
            className="md:col-span-2 lg:col-span-1 md:row-span-2 relative rounded-2xl md:rounded-3xl overflow-hidden group min-h-[250px] md:min-h-[300px]"
          >
            <img
              src={miningImg}
            ...
            <div className="absolute bottom-0 left-0 p-5 md:p-8">
              <div className="text-4xl sm:text-5xl md:text-6xl font-heading font-bold text-white/90 mb-1 md:mb-2 drop-shadow-lg">1974</div>
              <div className="text-lg md:text-xl font-bold text-white">Established Legacy</div>
              <p className="text-slate-300 text-xs md:text-sm mt-1 md:mt-2">Texas-born, globally trusted.</p>
            </div>
          </motion.div>
          ...
          <motion.div
            variants={itemVariants}
            whileHover={{ y: -5 }}
            className="md:col-span-2 lg:col-span-1 bg-accent rounded-2xl md:rounded-3xl p-6 md:p-8 flex flex-col justify-center items-center text-center relative overflow-hidden"
          >
            ...
            <Factory className="w-8 h-8 md:w-10 md:h-10 mb-3 md:mb-4 text-white/80" />
            <div className="text-3xl md:text-4xl font-bold mb-1">200k+</div>
          ...
          <motion.div
            variants={itemVariants}
            whileHover={{ y: -5 }}
            className="md:col-span-2 lg:col-span-1 bg-slate-900 border border-white/5 rounded-2xl md:rounded-3xl p-6 md:p-8 flex flex-col justify-center items-center text-center hover:bg-slate-800 transition-colors"
          >
            <Award className="w-8 h-8 md:w-10 md:h-10 mb-3 md:mb-4 text-accent" />
          ...
          <motion.div
            variants={itemVariants}
            className="md:col-span-4 lg:col-span-2 bg-slate-900 border border-white/5 rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 flex items-center"
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 md:gap-x-8 gap-y-3 md:gap-y-4 w-full">
              {[
                ...
                <div key={feature} className="flex items-center gap-2 md:gap-3">
                  ...
                  <span className="font-medium text-sm md:text-base text-slate-300">{feature}</span>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          <motion.div
            variants={itemVariants}
            whileHover={{ y: -5 }}
            className="md:col-span-2 lg:col-span-1 bg-white text-slate-950 rounded-2xl md:rounded-3xl p-6 md:p-8 flex flex-col justify-center items-center text-center"
          >
            <Users className="w-8 h-8 md:w-10 md:h-10 mb-3 md:mb-4 text-accent" />
